...
type user struct {
	...
	Password          field.String // 哈希密码
	Points            field.Int32  // 积分
	AvatarURL         field.String // 头像
	Email             field.String // 邮箱
	PhoneNumber       field.String // 加密电话
	PersonalSignature field.String // 个性签名
...
func (u *user) updateTableName(table string) *user {
	...
	u.PersonalSignature = field.NewString(table, "personal_signature")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["personal_signature"] = u.PersonalSignature
